	...
	<div class="section section-post-header">
		<div class="section_wrapper clearfix">
			...
			<div class="column one post-nav">
				...
				<?php if( $blog_page_id ): ?>
					<a class="list-nav" href="http://serene.local/all-properties/"><i class="icon-layout"></i><?php echo $translate['all']; ?></a>
				<?php endif; ?>
		...
		=================================-->
					...
					<table class="table-custom">
						<tbody>
							...
							<tr>
							<td>TOTAL UNITS:</td><td><?php echo get_the_term_list( $post->ID, 'total-units', '<li class="area_item"> ', ', ', '</li>' ) ?></td>
							<td>DEVELOPER:</td><td><?php echo get_the_term_list( $post->ID, 'developer', '<li class="area_item"> ', ', ', '</li>' ) ?></td>
							<td>COMPLETION:</td><td><?php echo get_the_term_list( $post->ID, 'completion', '<li class="area_item"> ', ', ', '</li>' ) ?>
							</td>
							</tr>
