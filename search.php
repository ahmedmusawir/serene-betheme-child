	...
	<div class="content_wrapper clearfix">
		...
		<div class="sections_group">
			...
			<section class="container">
				...
				<section id="primary" class="content-area col-md-9 col-lg-9">
												...
												<div class="tax-block">
													...
													<table class="table table-condensed">
														<tbody>
															...
															<td>BEDROOMS:</td><td><?php echo get_the_term_list( $post->ID, 'bedroom', '<span class="area_item"> ', ', ', '</span>' ) ?></td>
															</tr>

															<tr>
															<td>PRICE:</td><td><?php echo get_the_term_list( $post->ID, 'price', '<span class="area_item"> ', ', ', '</span>' ) ?></td>
															<td>SIZE:</td><td><?php echo get_the_term_list( $post->ID, 'size', '<span class="area_item"> ', ', ', '</span>' ) ?>
															</td>
															</tr>
